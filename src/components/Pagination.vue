<template>
    ...
    <div class="page-picker-show"><span>展示数据</span><select class="pc-input inputOne" v-model="pageSizeCode" style="padding-left:0"><option v-for="(obj,index) in pageSizeList" :value="index">{{obj}}</option></select></div>
