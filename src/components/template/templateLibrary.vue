<template>
  <div>
    <div class="templateToggle"><span>模板库</span><span @click="toggleTab">我创建的模板</span></div>
<div class="tempMain">
 ...
 <el-table :data="tableData" border height="380" style="width: 100%" stripe @selection-change="handleSelectionChange"
   ...
   <el-table-column prop="name" label="模板创建人" >
...
export default{
  ...
  methods:{
    onSelect(){},
    toggleTab(){
        this.$router.push({path:'myTemplate'});
       },
 search(){
...
.template_box{
 ...
 .templateToggle{position: absolute;top:20px;left:20%;cursor: pointer;
  &>span:nth-child(1){color:#0e72d8;margin-right:.2rem;}
