        ...
        <transition name="t1">
          <div v-show="toggle1==true">
            ...
            <div class="flex paddingLR2rem gray">
              ...
              <div class=" textInput marginL2VW"><span class="label2"><span class="icon-xing">*</span>培训结束时间</span><input
                  class='pc-input middleInput' /></div>
            </div>
            <div class="flex paddingLR2rem gray">
              <div class=" textInput"><span class="label2 verTop">培训内容介绍</span><textarea class='pc-textarea textareaOne'
                  style="width:6.5rem" /></div>
    </div>
    </div>
  </transition>
