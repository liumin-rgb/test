       ...
       <a-upload
        ...
        <span class="pc-input uploadS displayLB">点击上传<i class="iconfont icon-shangchuan floatR themeColor"></i></span>
         ...
         <el-table
             ...
             </el-table-column><el-table-column prop="" label="状态" width="50"></el-table-column>
              <el-table-column prop="age" label="仪器编号">
              </el-table-column>
              <el-table-column prop="political" label="仪器名称">
              </el-table-column>
              <el-table-column prop="political" label="使用部门">
              </el-table-column>
              <el-table-column prop="workingDate" label="仪器分类"
              ></el-table-column> 
           </el-table>
           </a-spin>
           </div>
